enum RomanNumeral {
    ...
    XLVII(47), XLVIII(48), XLIX(49), L(50), LI(51), LII(52), LIII(53),
    LIV(54), LV(55), LVI(56), LVII(57),    LVIII(58), LIX(59), LX(60),
    ...
    public static String toRoman(int number) {
        if (number < 1) {
            throw new IllegalArgumentException("Результат работы меньше единицы.");
        }
